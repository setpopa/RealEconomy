    ...
    public class CommandPay : IRocketCommand
    {
        ...
        public void Execute(IRocketPlayer caller, params string[] command) 
        {
            if (command.Length != 2) { UnturnedChat.Say(caller, 
                Uconomy.Instance.Translations.Instance.Translate("command_pay_invalid")); return; } 
            ...
            if (otherPlayer != null) 
            {
                ...
                int amount = 0;
                if (!int.TryParse(command[1], out amount) || amount <= RealEconomy.Instance.minValue) { Uconomy.Instance.Translations 
                ...
                if (caller is ConsolePlayer) {
                    ...
                    UnturnedChat.Say(otherPlayer.CSteamID, Uconomy.Instance.Translations.Instance
                        .Translate("command_pay_console", amount, Uconomy.Instance.Configuration.Instance.MoneyName)); 
                    return;
                } 
                else 
                {
                    ...
                    UnturnedChat.Say(caller, Uconomy.Instance.Translations.Instance
                        .Translate("command_pay_private", otherPlayer.CharacterName, amount, Uconomy.Instance.Configuration.Instance.MoneyName)); 
                    UnturnedChat.Say(otherPlayer.CSteamID, Uconomy.Instance.Translations.Instance
